 ...
 */
export declare type MemberJoinEvent = {
    type: "memberJoined";
    /**
 ...
 * or [room](https://developers.line.biz/en/docs/messaging-api/group-chats/#room) that the bot is in.
 */
export declare type MemberLeaveEvent = {
    type: "memberLeft";
    /**
...
declare type UserInteractionStatisticsOfEachMessage = {
    seq: number;
    impression: number;
    mediaPlayed: number;
...
declare type UserInteractionStatisticsOfEachURL = {
    seq: number;
    url: number;
    click: number;
    uniqueClick: number;
 ...
 */
export declare type UserInteractionStatistics = {
    overview: {
        requestId: string;
        timestamp: number;
        delivered: number;
...
declare type FilterOperatorObject<T> = {
    type: "operator";
} & ({
...
declare type DemographicObject = {
    type: "gender";
    oneOf: ("male" | "female")[];
} | {
    type: "age";
...
export declare type DemographicFilterObject = DemographicObject | FilterOperatorObject<DemographicObject>;
export declare type NarrowcastProgressResponse = ({
    phase: "waiting";
} | (({
...
export declare type AudienceGroupStatus = "IN_PROGRESS" | "READY" | "EXPIRED" | "FAILED";
export declare type AudienceGroupCreateRoute = "OA_MANAGER" | "MESSAGING_API";
declare type _AudienceGroup = {
    audienceGroupId: number;
    description: string;
    audienceCount: number;
    created: number;
...
export declare type AudienceGroup = _AudienceGroup & {
    jobs: AudienceGroupJob[];
};
export declare type AudienceGroups = _AudienceGroup[];
export declare type AudienceGroupAuthorityLevel = "PUBLIC" | "PRIVATE";
export declare type ChannelAccessToken = {
    access_token: string;
    expires_in: number;
    token_type: "Bearer";
    key_id?: string;
 ...
 */
export declare type GroupSummaryResponse = {
    groupId: string;
    groupName: string;
    pictureUrl: string;
};
