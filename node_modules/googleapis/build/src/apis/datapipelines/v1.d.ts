...
export declare namespace datapipelines_v1 {
    ...
    export class Resource$Projects$Locations {
         ...
         */
        listPipelines(params: Params$Resource$Projects$Locations$Listpipelines, options: StreamMethodOptions): GaxiosPromise<Readable>;
        listPipelines(params?: Params$Resource$Projects$Locations$Listpipelines, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDatapipelinesV1ListPipelinesResponse>;
        listPipelines(params: Params$Resource$Projects$Locations$Listpipelines, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        listPipelines(params: Params$Resource$Projects$Locations$Listpipelines, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudDatapipelinesV1ListPipelinesResponse>, callback: BodyResponseCallback<Schema$GoogleCloudDatapipelinesV1ListPipelinesResponse>): void;
        listPipelines(params: Params$Resource$Projects$Locations$Listpipelines, callback: BodyResponseCallback<Schema$GoogleCloudDatapipelinesV1ListPipelinesResponse>): void;
        listPipelines(callback: BodyResponseCallback<Schema$GoogleCloudDatapipelinesV1ListPipelinesResponse>): void;
    }
    export interface Params$Resource$Projects$Locations$Listpipelines extends StandardParameters {
        /**
         * An expression for filtering the results of the request. If unspecified, all pipelines will be returned. Multiple filters can be applied and must be comma separated. Fields eligible for filtering are: + `type`: The type of the pipeline (streaming or batch). Allowed values are `ALL`, `BATCH`, and `STREAMING`. + `executor_type`: The type of pipeline execution layer. This is always Dataflow for now, but more executors may be added later. Allowed values are `ALL` and `DATAFLOW`. + `status`: The activity status of the pipeline. Allowed values are `ALL`, `ACTIVE`, `ARCHIVED`, and `PAUSED`. For example, to limit results to active batch processing pipelines: type:BATCH,status:ACTIVE
         */
        filter?: string;
    ...
    export class Resource$Projects$Locations$Pipelines {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Pipelines$Create, options: StreamMethodOptions): GaxiosPromise<Readable>;
        create(params?: Params$Resource$Projects$Locations$Pipelines$Create, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDatapipelinesV1Pipeline>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Pipelines$Delete, options: StreamMethodOptions): GaxiosPromise<Readable>;
        delete(params?: Params$Resource$Projects$Locations$Pipelines$Delete, options?: MethodOptions): GaxiosPromise<Schema$GoogleProtobufEmpty>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Pipelines$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Projects$Locations$Pipelines$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDatapipelinesV1Pipeline>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Pipelines$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Projects$Locations$Pipelines$Patch, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDatapipelinesV1Pipeline>;
        ...
        run(params?: Params$Resource$Projects$Locations$Pipelines$Run, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDatapipelinesV1RunPipelineResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        stop(params: Params$Resource$Projects$Locations$Pipelines$Stop, options: StreamMethodOptions): GaxiosPromise<Readable>;
        stop(params?: Params$Resource$Projects$Locations$Pipelines$Stop, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDatapipelinesV1Pipeline>;
